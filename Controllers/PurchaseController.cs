...
namespace Project_RentACar.Controllers
{
    public class PurchaseController : Controller
    {
        ...
        public PurchaseController(AccountDAO accountDAO, FinanceDAO financeDAO, HomestayDAO homestayDAO,
        ...
        public IActionResult PurchaseByPaypal()
        {
            ...
            string total = (rental_contract.TotalAmount + ADDITIONAL_FEE + rental_contract.TotalAmount / 100 * 10)
                .ToString("#,##0.00");
        ...
        private void SendPurchaseSuccessfulMailToCustomer(BookingContract contract, Homestay thisHomestay)
        {
            ...
            if (htmlContent != "")
            {
                ...
                string invoice_link = $"{Request.Scheme}://{Request.Host}" + "/Profile/ViewRentalDetail?rental_id=" +
                                      contract.BookingId;
